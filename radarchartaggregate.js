...
var allAxis;
 ...
 function radarChartDrawTotal(sdg_data, district_input) {
     ...
     var   subset_radar_1 = sdg_data.filter(function(el) {
                return el.District === district_input && el.Demographic === "TOTAL"});
     
      var   subset_radar_rwanda = sdg_data.filter(function(el) {
                return el.District === "RWANDA" && el.Demographic === "TOTAL"});
     ...
     var    subset_radar = subset_radar_1.filter(function(el) {
                return el.Year  === EICV_YEAR || el.Year === DHS_YEAR ;});
     
     var subset_radar_rwanda_final = subset_radar_rwanda.filter(function(el) {
                return el.Year  === EICV_YEAR || el.Year === DHS_YEAR ;});
   ...
   var   radar_data = [
       subset_radar_rwanda_final,
          subset_radar  
			...
			RadarChart(".radarchartaggregate", radar_data, radarChartOptions); 
